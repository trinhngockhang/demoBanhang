                            ...
                            <div className="widget-ft widget-newsletter">
                                ...
                                <form action="#" className="subscribe-form" method="get" acceptCharset="utf-8">
                                    <div className="subscribe-content">
                                        ...
                                        <button type="submit"><img src="/static/images/icons/right-2.png" alt="" /></button>
                                    </div>
                                </form>
                                <ul className="pay-list">
                                    <li>
                                        <a href="#" title="">
                                            <img src="/static/images/logos/ft-01.png" alt="" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <img src="/static/images/logos/ft-02.png" alt="" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <img src="/static/images/logos/ft-03.png" alt="" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <img src="/static/images/logos/ft-04.png" alt="" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <img src="/static/images/logos/ft-05.png" alt="" />
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="widget widget-apps">
                                ...
                                <ul className="app-list">
                                    ...
                                    <li className="google-play">
                                        <a href="#" title="">
                                            <div className="img">
                                                <img src="/static/images/icons/google-play.png" alt="" />
                                            </div>
                                            <div className="text">
                                                <h4>Google Play</h4>
                                                <p>Tải về</p>
